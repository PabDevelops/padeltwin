...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 26, fontWeight: '900', color: theme.text, textTransform: 'uppercase', letterSpacing: -0.5 },
  ...
  infoValue: { fontSize: 13, fontWeight: '900', color: theme.text, textTransform: 'uppercase' },
  ...
  sectionHeader: { fontSize: 10, fontWeight: '900', color: theme.primary, letterSpacing: 1.5, marginBottom: 14, borderBottomWidth: 1, borderBottomColor: theme.border, paddingBottom: 6, textTransform: 'uppercase' },
  ...
  playerInfo: { flex: 1 },
  playerName: { fontSize: 13, fontWeight: '900', color: theme.text, textTransform: 'uppercase', letterSpacing: 0.2 },
  ...
  scoreTeamPlayers: { fontSize: 13, fontWeight: '800', color: theme.text, marginTop: 2, textTransform: 'uppercase' },
  ...
  setScoreBoxWinner: { backgroundColor: 'rgba(255, 92, 0, 0.12)', borderColor: theme.primary },
  ...
  label: { fontSize: 9, fontWeight: '900', color: theme.textMuted, letterSpacing: 1, marginBottom: 8, textTransform: 'uppercase' },
  ...
  addSet: { color: theme.primary, fontWeight: '900', fontSize: 11, letterSpacing: 0.5, textTransform: 'uppercase' },
  error: { color: theme.danger, fontWeight: '700', fontSize: 12, marginTop: 12, textAlign: 'center', textTransform: 'uppercase' },
});
